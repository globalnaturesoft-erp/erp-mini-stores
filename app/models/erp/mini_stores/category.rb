module Erp::MiniStores
  class Category < ApplicationRecord
    ...
    belongs_to :parent, class_name: "Erp::MiniStores::Category", optional: true
    has_many :children, class_name: "Erp::MiniStores::Category", foreign_key: "parent_id"
    ...
    def self.filter(query, params)
      ...
      query = query.joins("LEFT JOIN erp_mini_stores_categories parents_erp_mini_stores_categories ON parents_erp_mini_stores_categories.id = erp_mini_stores_categories.parent_id")
