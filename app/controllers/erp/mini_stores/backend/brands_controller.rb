      ...
      class BrandsController < Erp::Backend::BackendController
        ...
        def create
          ...
          if @brand.save
            if request.xhr?
              ...
              redirect_to erp_mini_stores.edit_backend_brand_path(@brand), notice: t('.success')
            end
          else
            render :new        
          end
        ...
        def destroy
          ...
          respond_to do |format|
            format.html { redirect_to erp_mini_stores.backend_brands_path, notice: t('.success') }
            format.json {
              render json: {
                'message': t('.success'),
                'type': 'success'
        ...
        private
          ...
          def brand_params
            params.fetch(:brand, {}).permit(:image_url, :name, :description, :meta_keywords, :meta_description)
          end
      end
    end
  end
