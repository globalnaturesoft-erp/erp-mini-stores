      ...
      class CategoriesController < Erp::Backend::BackendController
        ...
        def create
          ...
          if @category.save
            if request.xhr?
              ...
              redirect_to erp_mini_stores.edit_backend_category_path(@category), notice: t('.success')
            end
          else
        ...
        def destroy
          ...
          respond_to do |format|
            format.html { redirect_to erp_mini_stores.backend_categories_path, notice: t('.success') }
            format.json {
              render json: {
                'message': t('.success'),
                'type': 'success'
        ...
        private
          ...
          def category_params
            params.fetch(:category, {}).permit(:name, :parent_id, :meta_keywords, :meta_description)
          end
      end
    end
  end
